      ...
      <div className="bg-white dark:bg-dark-surface w-full max-w-md rounded-2xl shadow-2xl p-8 animate-in fade-in zoom-in duration-200">
        ...
        <div className="mb-8">
          <p className="text-gray-600 dark:text-gray-400">
            Are you sure you want to delete the list <span className="font-bold text-gray-900 dark:text-gray-200">"{listTitle}"</span>?
            All cards within this list will be permanently removed.
          </p>
        </div>
